...
lang_tr_tr[N__MAX_] =
{
	...
	[N__TRAY_ICON] = u8"Tepsi Simgesi",
	[N__TRAY_DATA_SOURCE] = u8"Veri kaynağı",
	[N__TRAY_COLOR_MODE] = u8"Renk modu",
	[N__TRAY_OFF] = u8"Kapalı",
	[N__TRAY_CPU_USAGE] = u8"CPU Kullanımı",
	[N__TRAY_CPU_TEMP] = u8"CPU Sıcaklığı",
	[N__TRAY_MEM_USAGE] = u8"Bellek Kullanımı",
	[N__TRAY_BATTERY] = u8"Pil",
	[N__TRAY_DYNAMIC] = u8"Dinamik",
	[N__TRAY_FIXED] = u8"Sabit",
};
